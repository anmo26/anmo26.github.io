...
- by master yoda! (8nmirhlz), 8 days ago
...
- by unsigned (r5u3jewz), 8 days ago
...
- by unsigned (1cee3n80), 8 days ago
...
**decided:** three landings and he is standing still
...
**decided:** the bin is the door to the crypt; the spade is gone
...
**decided:** every page counts its own people, once per browser
...
**decided:** the bin was under the music player. it is on the other side now
...
**decided:** put back on every thing in the crypt
...
**decided:** THE FORUM, a real board on its own document
...
**decided:** replies behind a fold, a notes switch, and idea vs chat
...
**decided:** he lands on notes and sometimes goes head first into one
...
**decided:** the ledger and the inbox — read, triaged, and only built when you say so
...
**decided:** he is a mini fig with four gaits
...
**decided:** colour comes from the hand; notes can be signed
...
**decided:** theme and pattern open on hover; scan deleted
...
- **idea**, front page · todo.md — *taken off the wall*
- by unsigned (1jqlbgq2), 8 days ago
